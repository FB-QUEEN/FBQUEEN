...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : TANIM-OFFICIAL'
    print 'FACEBOOK : EH Tanim'
    print 'GITHUB     : Termux-TANIM'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[TANIM-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
